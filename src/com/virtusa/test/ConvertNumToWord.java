...
public class ConvertNumToWord {
    ...
    public static void main(String[] args) {
        System.out.println("999999999- " + convertNumber(999999999));
        System.out.println("56945781- " + convertNumber(56945781));
        System.out.println("105- " + convertNumber(105));
        System.out.println("21- " + convertNumber(21));
        System.out.println("1- " + convertNumber(1));
    }
}